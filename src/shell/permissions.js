...
export class PermissionsConstructor {
    constructor(room) {
        ...
        // time/weather commands (day/night/rain/storm/snowstorm) moved to the legacyweather
        // plugin - see its shared.js, registered via the permissionsAfterSetup emit right below.
