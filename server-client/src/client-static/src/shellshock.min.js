...
function setParticleSystems(gameOptionsP = gameOptions) {
    if (gameOptionsP.weather.snowStormEnabled && gameScene.shadowsEnabled) {
        snowParticleSystem.start();
    } else {
        snowParticleSystem.stop();
    };

    if (gameOptionsP.weather.rainEnabled && gameScene.shadowsEnabled) {
            ...
            case Comm.Code.updateRoomParams:
                ...
                switch (roomParamsObj.time) {
                    ...
                    default:
                        ...
                        if (roomParamsObj.weather.snowStormEnabled) {
                ...
                if (roomParamsObj.weather.stormEnabled) {
                    ...
                    if (!roomParamsObj.weather.snowStormEnabled) setFog();
                };
