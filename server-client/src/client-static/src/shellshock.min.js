        ...
        switch (cmd) {
            ...
            case Comm.Code.sync:
                ...
                if (id == meId) {
                    ...
                    if (Math.abs(player.x - x) > 0.05) player.x = x;
                    if (Math.abs(player.y - y) > 0.05) player.y = y;
                    if (Math.abs(player.z - z) > 0.05) player.z = z;
                    ...
                    player.stateIdx = stateIdx // - FramesBetweenSyncs;
