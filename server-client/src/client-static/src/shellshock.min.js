    ...
    while (input.isMoreDataAvailable()) {
        ...
        switch (cmd) {
            ...
            case Comm.Code.changeCharacter:
                ...
                // console.log(classIdx, primaryWeaponItem, secondaryWeaponItem, shellColor, hatItem, stampItem)
...
function joinGame() { //2nd, request made to server to find game. handles cases where game isnt found
    ...
    var joinGameId = document.getElementById("joinCode").value.trim().slice(-7);
    var mapId = 0;
