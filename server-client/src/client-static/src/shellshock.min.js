...
GunActor.prototype.setup = function (muzFlashZ) {
  ...
  this.testEmitter = new Emitter(this.gunMesh);
};
...
function startRendering() { //16th, starts rendering and game loop
  ...
  engine.runRenderLoop(function () { gameScene.render(); Emitter.updateAll(); if(camera) Howler.pos(camera.x, camera.y, camera.z)});
};
