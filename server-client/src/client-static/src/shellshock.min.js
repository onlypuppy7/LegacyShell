...
var settingsKeyNames = ["up", "down", "left", "right", "jump", "fire", "scope", "reload", "weapon", "grenade"];
        ...
        switch (cmd) {
            ...
            case Comm.Code.fire:
                ...
                var seed = input.unPackInt8U(),
                    player = players[id];
                if (!player) break;
                id != meId && player.weapon.actor.fire(), Math.seed = seed, player.weapon.fireMunitions(tv1, tv2);
                break;
...
function onLoadingComplete() {
    console.log("onLoadingComplete"); Collider = new ColliderConstructor(gameScene),
        function (onComplete) {
            function complete() {
