...
PlayerActor.prototype.hit = function () {
    this.hitSoundDelay <= 0 && (this.hitSound.setPosition(new BABYLON.Vector3(this.playerActor.mesh.position.x, this.playerActor.mesh.position.y, this.playerActor.mesh.position.z)), this.hitSound.play(), this.hitSoundDelay = 10)
};
