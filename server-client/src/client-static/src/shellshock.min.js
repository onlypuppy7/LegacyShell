...
function setGameTypeSelect() {
    ...
    var oldSelectedIndex = gameTypeSelect.selectedIndex > 0 ? gameTypeSelect.selectedIndex : 0;
...
function onPageLoaded () {
    ...
    if (0 < missingFeatures) {
        ...
        if (parsedUrl.query.testMap) {
          ...
          devlog(`testMap startGame(), would've played on gameType ${gameType}, focing to 0...`);
          playerLimit = 1;
          gameType = 0;
          ws = {
            send: function () { }
