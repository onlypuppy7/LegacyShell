        ...
        switch (cmd) {
            ...
            case Comm.Code.reload:
                ...
                if (id == meId) {
                    ...
                    console.log("reloading me", me.weapon.ammo.rounds, me.weapon.ammo.store, rounds, store, roundsToReload);
            ...
            case Comm.Code.setModifiers:
                ...
                //unsigned
                var scale = input.unPackInt8U() / 10;
                //signed
                var regenModifier = input.unPackInt8() / 10;
                var speedModifier = input.unPackInt8() / 10;
                var gravityModifier = input.unPackInt8() / 10;

                if (player) {
                    player.changeScale(scale);
                    player.regenModifier = regenModifier;
