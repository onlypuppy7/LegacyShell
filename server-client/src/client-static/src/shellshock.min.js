...
const autocomplete = {
    ...
    show: function (text) {
        ...
        autocomplete.suggestions = autocomplete.commands.filter(cmd => cmd.includes(text.slice(1)));
        ...
        autocomplete.dialog.style.marginLeft = (getStringWidth(chatInEl.value) * 2) + "px";
    ...
    enter: function () {
        chatInEl.value = autocomplete.selected;
    },
};
