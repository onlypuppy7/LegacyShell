        ...
        switch (cmd) {
            ...
            case Comm.Code.die:
                ...
                if (killedPlayer) {
                    ...
                    playSoundIndependent("death.scream", pos, killedPlayer.actor.playbackRate);
...
function loadMaterials(scene) { //5th, defines materials
    ...
    mat.onBind = function (mesh) {
        ...
        // console.log(scene, scene.sunLight);
...
function loadSounds(scene, onComplete) { //6th, loads sounds (who knew?)
    ...
    //grenade
        ...
        /*
    //Deaths
        ["sound/death/scream1.mp3", "death.scream.0"],
        ["sound/death/scream2.mp3", "death.scream.1"],
        ["sound/death/scream3.mp3", "death.scream.2"],
        ["sound/death/scream4.mp3", "death.scream.3"],
        ["sound/death/scream5.mp3", "death.scream.4"],
        ["sound/death/scream6.mp3", "death.scream.5"],
        ["sound/death/scream7.mp3", "death.scream.6"],
        ["sound/death/scream8.mp3", "death.scream.7"],
        ["sound/death/scream9.mp3", "death.scream.8"],
        ["sound/death/scream10.mp3", "death.scream.9"],
        */
    //ambiance (puppy :D)
        ["sound/ambiance/rain.mp3", "rain"],
        ["sound/ambiance/thunder.mp3", "thunder"]
    ];

    //why did you even load twice?
    /*
    //deaths
    for (var i = 1; i < 11; i++) {
...
function refreshMapPool () {
    ...
    var oldMap = currentMapPool[oldIndex];
    ...
    if (currentMapPool.includes(oldMap)) {
        mapSelect.selectedIndex = currentMapPool.indexOf(oldMap);
    } else {
