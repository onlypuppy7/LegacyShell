...
function setParticleSystems(gameOptions = gameOptions) {
    if (gameOptions.weather.snowStormEnabled && gameScene.shadowsEnabled) {
        snowParticleSystem.start();
    } else {
        snowParticleSystem.stop();
    };

    if (gameOptions.weather.rainEnabled && gameScene.shadowsEnabled) {
